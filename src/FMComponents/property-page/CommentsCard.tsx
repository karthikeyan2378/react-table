...
/**
 * A generic component for displaying and adding comments. It includes loading skeletons
 * and state management for the new comment input.
 */
export function CommentsCard({
    ...
    return (
        <InfoCard title={title} className="details-card-small">
