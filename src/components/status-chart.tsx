...
interface ColumnChartProps {
  ...
  label: string;
  data: Alarm[];
  onRemove: (columnId: keyof typeof alarmConfig.fields) => void;
  onUpdateChartType: (columnId: keyof typeof alarmConfig.fields, chartType: ChartType) => void;
...
export function ColumnChart({
  ...
  const handleChartTypeChange = (type: ChartType) => {
    setChartType(type);
    onUpdateChartType(columnId, type);
  };
        ...
        <div className="flex items-center gap-1">
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem onClick={() => handleChartTypeChange('doughnut')}>
